...
#-----------------------------------------------------------------------
# INSERT_CONFIG_HERE
# Configurarion file for back_public-q_Photos_Dir1_a_rojo

TGT_SCRIPT_NAME="back_public-q-Photos_Dir1_a_rojo.sh"
